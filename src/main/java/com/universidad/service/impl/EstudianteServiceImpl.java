...
public class EstudianteServiceImpl implements IEstudianteService { // Define la clase EstudianteServiceImpl que implementa la interfaz IEstudianteService
    ...
    public EstudianteDTO obtenerEstudiantePorNumeroInscripcion(String numeroInscripcion) {
        ...
        // Busca el estudiante por su número de inscripción
    ...
    public EstudianteDTO crearEstudiante(EstudianteDTO estudianteDTO) {
        ...
        if (estudianteRepository.findByNumeroInscripcion(estudianteDTO.getNumeroInscripcion()) != null) {
            throw new IllegalArgumentException("El número de inscripción ya existe: " + estudianteDTO.getNumeroInscripcion());
        }

        // Asignar valores por defecto si no se proporcionan
        if (estudianteDTO.getFechaAlta() == null) {
            estudianteDTO.setFechaAlta(LocalDate.now());
        }
        if (estudianteDTO.getUsuarioAlta() == null) {
            estudianteDTO.setUsuarioAlta("admin"); // O recuperar del contexto de seguridad
        }
        if (estudianteDTO.getEstado() == null) {
            estudianteDTO.setEstado("activo");
        }
    ...
    private Estudiante convertToEntity(EstudianteDTO estudianteDTO) {
        return Estudiante.builder()
                // NO asignar ID aquí en la creación. JPA lo manejará.
