...
public class MateriaController {
    ...
    @PutMapping("/{materiaId}/asignar-docentes")
    public ResponseEntity<MateriaDTO> asignarDocentesAMateria(
            @PathVariable Long materiaId,
            @RequestBody List<String> nroEmpleados) {

        MateriaDTO materiaActualizada = materiaService.asignarDocentesAMateria(materiaId, nroEmpleados);
